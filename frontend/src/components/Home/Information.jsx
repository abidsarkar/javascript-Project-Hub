...
const Information = () => {
  return (
    <div className="bg-white text-black py-12"> {/* Added padding */}
      <div className="container mx-auto"> {/* Added container for centering */}
        <h1 className="text-center text-3xl md:text-5xl font-bold leading-tight mb-6"> {/* Improved heading styles */}
          Frontend Practice provides you with <br /> the inspiration and resources to create <br /> beautiful websites.
        </h1>
        <p className="text-center text-lg md:text-2xl font-normal mb-12 px-4 md:px-0"> {/* Improved paragraph styles */}
          Here are some ways you can benefit <br /> from using our platform:
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center"> {/* Responsive grid */}
        ...
        <div className="text-center mt-12"> {/* Centered button container */}
          <h2 className="text-2xl font-bold mb-6">Ready to become a better frontend developer?</h2>
          
          <NavLink to="/project" className="text-black hover:text-white  btn btn-outline transition duration-300"> 
            View Project
          </NavLink> 
        </div>
      </div>
